...
| Source CLI | Keyless run, canonical chat, provider/capability discovery, doctor, structured output modes, exit codes, completions | `crates/aikit-cli`, unit and binary integration tests | Complete locally |
